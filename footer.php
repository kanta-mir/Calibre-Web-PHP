...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".open-AddBookDialog", function() {
            ...
            var bookLangId = $(this).data('langid');
            ...
            var bookPublishersId = $(this).data('publisherid');
            ...
            $(".modal-body #bookFormatsLink").attr('href', "search.php?t=format&s=" + bookFormat);
            ...
            $(".modal-body #bookLangLink").attr('href', "search.php?t=language&s=" + bookLangId);
            $(".modal-body #bookRating").html(bookRating);
            $(".modal-body #bookRatingsLink").attr('href', "search.php?t=ratings&s=" + bookRating);
            ...
            $(".modal-body #bookTagsLink").attr('href', "search.php?t=tags&s=" + bookTags);
            $(".modal-body #bookPublisher").html(bookPublisher);
            $(".modal-body #bookPublishersLink").attr('href', "search.php?t=publisher&s=" + bookPublishersId);
